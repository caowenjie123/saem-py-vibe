...
print("cond_var_phi:", result.results.cond_var_phi)
print("min cond_var_phi:", np.min(result.results.cond_var_phi))
print("b (half-width):", (result.results.cond_mean_phi[:, result.model.indx_omega] - result.results.mean_phi[:, result.model.indx_omega]) / 2)
