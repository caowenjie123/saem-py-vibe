...
def conditional_distribution_c(phi1, phii, idi, xi, yi, mphi, idx, iomega, trpar, model, pres, err, ytype=None):
    """
...
def conditional_distribution_d(phi1, phii, idi, xi, yi, mphi, idx, iomega, trpar, model):
    """
        ...
        if model.modeltype == "structural":
            ...
            def objective(phi1_opt):
                return conditional_distribution_c(
                    phi1_opt, phii, idi, xi, yi, mean_phi1, i1_omega2, iomega_phi1,
                    model.transform_par, model.model, results.respar, model.error_model, ytype
                )
        else:
            def objective(phi1_opt):
                return conditional_distribution_d(
                    phi1_opt, phii, idi, xi, yi, mean_phi1, i1_omega2, iomega_phi1,
                    model.transform_par, model.model
                )
